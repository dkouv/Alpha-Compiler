...
{
       0,   254,   254,   261,   254,   267,   270,   271,   283,   289,
     295,   303,   319,   341,   342,   347,   350,   351,   352,   353,
     354,   355,   356,   367,   378,   389,   398,   408,   416,   417,
     418,   431,   437,   445,   454,   480,   502,   525,   546,   549,
     599,   605,   614,   615,   622,   631,   699,   734,   753,   762,
     771,   786,   786,   787,   787,   790,   798,   797,   821,   837,
     849,   852,   866,   876,   886,   902,   909,   927,   943,   948,
     962,   965,   976,   976,   978,   979,   982,  1025,  1025,  1025,
    1025,   981,  1048,  1071,  1071,  1071,  1071,  1047,  1098,  1106,
    1113,  1120,  1126,  1134,  1143,  1180,  1219,  1223,  1223,  1231,
    1240,  1251,  1260,  1259,  1275,  1281,  1281,  1274,  1302,  1303,
    1302,  1316,  1324,  1329,  1336,  1336,  1315,  1361,  1371
};
#endif
...
#line 351 "parser.y" /* yacc.c:1646  */
    {printf(BLUE "expr + expr\n" RESET); printf("TIPOS :%s\n", expression_types[(yyvsp[-2].my_expr)->type]);(yyval.my_expr) = calculate_expr(add, (yyvsp[-2].my_expr), (yyvsp[0].my_expr));}
...
#line 416 "parser.y" /* yacc.c:1646  */
    {printf(BLUE "expr and expr\n" RESET);printf("str :%s %s\n", (yyvsp[-2].my_expr)->strConst , (yyvsp[0].my_expr)->strConst); (yyval.my_expr) = calculate_expr(and, (yyvsp[-2].my_expr), (yyvsp[0].my_expr)); printf("ENd of and\n");}
#line 1924 "parser.c" /* yacc.c:1646  */
    break;

  case 29:
#line 417 "parser.y" /* yacc.c:1646  */
    {printf(BLUE "expr or expr\n" RESET); (yyval.my_expr) = calculate_expr(or, (yyvsp[-2].my_expr), (yyvsp[0].my_expr));}
...
#line 438 "parser.y" /* yacc.c:1646  */
    {
				...
				(yyval.my_expr) = calculate_expr(uminus, (yyvsp[0].my_expr), (yyvsp[0].my_expr));
				printf("- expr -> " RESET);
			}
...
#line 455 "parser.y" /* yacc.c:1646  */
    {
					...
					(yyval.my_expr) = create_quad(add, ena, (yyvsp[0].my_expr), (yyvsp[0].my_expr));
...
#line 481 "parser.y" /* yacc.c:1646  */
    {
					...
					(yyval.my_expr) = create_quad(add, (yyvsp[-1].my_expr), ena, (yyvsp[-1].my_expr));
...
#line 503 "parser.y" /* yacc.c:1646  */
    {
					...
					(yyval.my_expr) = create_quad(sub, (yyvsp[0].my_expr), ena, (yyvsp[0].my_expr));
...
#line 526 "parser.y" /* yacc.c:1646  */
    {
					...
					(yyval.my_expr) = create_quad(sub, (yyvsp[-1].my_expr), ena, (yyvsp[-1].my_expr));
					printf(BLUE "lvalue-- -> " RESET);
				}
...
#line 550 "parser.y" /* yacc.c:1646  */
    {	
					...
					if(expr_node){
						...
						if(symbol_get_value_type(expr_node->type) == 1 && strcmp((yyvsp[-2].my_expr)->strConst, expr_node->value.funcVal->name) == 0){
							printf(RED "Cannot perform assignment with function at line :%d\n"RESET, yylineno); 
						} 
					}else {
						entry e = look_up((yyvsp[-2].my_expr)->strConst, scope);
					...
					if ((yyvsp[0].my_expr)->type == newtable_e) {
						...
						(yyval.my_expr) = newexpr(assignexpr_e);
						(yyval.my_expr)->type = assignexpr_e;
						(yyval.my_expr)->sym = Scope_List_Contains_Symbol((yyval.my_expr)->strConst, scope);
...
#line 754 "parser.y" /* yacc.c:1646  */
    { 
					...
					(yyval.my_expr) = (yyvsp[0].my_expr);
					printf(YELLOW "\t2 : %s -@@@@@@@@@@- %d\n" RESET, (yyval.my_expr)->strConst, (yyval.my_expr)->type);
...
#line 771 "parser.y" /* yacc.c:1646  */
    { 
				...
				printf(RED "------------%s----------" RESET,(yyvsp[-3].my_expr)->strConst);
				printf("$expr->CONSTINT------------>%d\n",(yyvsp[-1].my_expr)->const_int);
				(yyval.my_expr) = newexpr(tableitem_e);
				(yyval.my_expr)->sym = (yyvsp[-3].my_expr)->sym;
				(yyval.my_expr)->strConst = strdup((yyvsp[-3].my_expr)->strConst);
...
#line 822 "parser.y" /* yacc.c:1646  */
    {
					...
					printf("$2 is %s\n", (yyvsp[-4].my_entry)->value.funcVal->name);
...
#line 1144 "parser.y" /* yacc.c:1646  */
    {
				...
				argument_list_head = insert_new_argument(argument_list_head, (yyvsp[0].str));
