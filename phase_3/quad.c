...
/* na tipwsoume alla args opws  jump, uminus ktl */  
    ...
    else if (my_expr->type == conststring_e || my_expr->type == var_e){
...
void write_quad_general(quad q){
    ...
    if(q->op == if_eq_op){
        ...
        write_label_offset(f);
        write_assign_quad_to_file("ASSIGN", q->arg1->strConst, q->arg2, f);
    }else if(q->op == jump){
        write_label_offset(f);
...
int valid_expression_arg(expr arg1, expr arg2){
    if((is_const_num(arg1) != 1 && arg1->type !=var_e ) ||(is_const_num(arg2) != 1 && arg2->type != var_e)){
...
expr create_quad(int op, expr arg1, expr arg2, expr result) {
    ...
    switch(op){
        ...
        case 1:
            ...
            /*tmp_quad->result->type = get_result_num_type(arg1, arg2);
            res = get_expr_value(arg1) + get_expr_value(arg2);
            if(tmp_quad->result->type == constdouble_e){
                tmp_quad->result->const_double = res;
            }else {
                printf("RESULT:%d\n", (int)res);
                tmp_quad->result->const_int = (int)res;
            }*/
            
            /* edw thelei na ftiaksoume too entry kai to index */
            //tmp_quad->result->type = conststring_e;
            tmp_quad->result->type = var_e;
            //write_quad_to_file("ADD", tmp_quad->result->strConst, tmp_quad->arg1, tmp_quad->arg2);
        ...
        case 2:
            ...
            tmp_quad->result->type = var_e;
            //write_quad_to_file("SUB", tmp_quad->result->strConst, tmp_quad->arg1, tmp_quad->arg2);
        ...
        case 4:
            ...
            edw thelei na ftiaksoume too entry kai to index */
            //write_quad_to_file("MUL", tmp_quad->result->strConst, tmp_quad->arg1, tmp_quad->arg2);
            tmp_quad->result->type = var_e;
            //write_quad_to_file("MUL", tmp_quad->result->strConst, tmp_quad->arg1, tmp_quad->arg2);
        ...
        case 5:
            /*division */
            // if(get_expr_value(arg2) == 0){
            //     printf(RED"Sfalma katatmisis, diaresi me 0\n"RESET);
            //     exit(-1);
            // }
            // tmp_quad->result->type = get_result_num_type(arg1, arg2);
            ...
            // /* edw thelei na ftiaksoume too entry kai to index */
            // write_quad_to_file("DIV", tmp_quad->result->strConst,tmp_quad->arg1, tmp_quad->arg2);
            tmp_quad->result->type = var_e;
            //write_quad_to_file("DIV", tmp_quad->result->strConst, tmp_quad->arg1, tmp_quad->arg2);
        ...
        case 6:
            ...
            //     break;
            // }
            // if(get_result_num_type(arg1, arg2) != constint_e){
            //     printf(RED"Den borei na ginei mod me double\n"RESET);
            //     break;
            // }
            // res = (int)get_expr_value(arg1) % (int)get_expr_value(arg2);            
            // tmp_quad->result->const_int = (int)res;

            // /* edw thelei na ftiaksoume too entry kai to index */
            // write_quad_to_file("MOD", tmp_quad->result->strConst, tmp_quad->arg1, tmp_quad->arg2);
            tmp_quad->result->type = var_e;
            //write_quad_to_file("MOD", tmp_quad->result->strConst, tmp_quad->arg1, tmp_quad->arg2);
        ...
        case 7:
            /*Uminus*/
            // tmp_quad->result->type = get_result_num_type(arg1, arg1);
            // if(tmp_quad->result->type == constint_e){
            //     tmp_quad->result->const_int = - (int)get_expr_value(arg1);
               
            
            
            // }else{ 
            //     tmp_quad->result->const_double = - get_expr_value(arg1);
            // }
            // write_quad_to_file("UMINUS", tmp_quad->result->strConst,  tmp_quad->arg1, NULL);
            tmp_quad->result->type = var_e;
            //write_quad_to_file("Uminus", tmp_quad->result->strConst, tmp_quad->arg1, tmp_quad->arg2);

            break;   
        case 8:
            /*AND*/
            
            // tmp_quad->result->type = constbool_e;
            // tmp_quad->result->boolConst = is_expression_true(arg1) && is_expression_true(arg2);
            // /* edw thelei na ftiaksoume too entry kai to index */
            // write_quad_to_file("AND", tmp_quad->result->strConst, tmp_quad->arg1, tmp_quad->arg2);
            // tmp_quad->result->type = var_e;
            //write_quad_to_file("AND", tmp_quad->result->strConst, tmp_quad->arg1, tmp_quad->arg2);
        ...
        case 9:
            ...
            //tmp_quad->result->type = constbool_e;
            //tmp_quad->result->boolConst = is_expression_true(arg1) || is_expression_true(arg2);
            //write_quad_to_file("OR", tmp_quad->result->strConst, tmp_quad->arg1, tmp_quad->arg2);
            break;      
        case 10:
            /*not*/
        
            //tmp_quad->result->type = constbool_e;
            // if(is_expression_true(arg1)){
            //     tmp_quad->result->boolConst = false;
            // }
            // else{
            //     tmp_quad->result->boolConst = true;
            // }

            //tmp_quad->result->type = conststring_e;
            /* edw thelei na ftiaksoume too entry kai to index */
            //write_quad_to_file("NOT", tmp_quad->result->strConst,  tmp_quad->arg1, tmp_quad->arg2);
            break;   
        case 11:
            /*if_equal*/
            printf(RED" na tsekarw gia undefined edw\n"RESET);
            /*sigkrinw 2 diaforetikes ekfraseis */
            // if(arg1 != true_expression && arg2 != true_expression){
            //     write_quad = 0;
            // // bool_res = equal_expression(arg1, arg2);
            // // if(bool_res == 0){
            // //     runtime_error = 1;
            // //     printf("Operators aren't the same type\n");
            // }else
                //write_if_quad_to_file("IF_EQ", tmp_quad->arg1, tmp_quad->arg2, tmp_quad->result);

            //     tmp_quad->result->boolConst = bool_res;
            //     write_quad = 0;
            // }else{
            //     bool_res = is_expression_true(arg1);
            //tmp_quad->result->type = constbool_e;
        ...
        case 12:
            ...
            // /*sigkrinw 2 diaforetikes ekfraseis */
            // if(arg1 != true_expression && arg2 != true_expression){
            //     //bool_res = reverse_result(equal_expression(arg1, arg2));
            //     //tmp_quad->result->boolConst = bool_res;
            //     write_quad = 0;
            ...
            // //     bool_res = is_expression_true(arg1);
            // //     tmp_quad->result->boolConst = bool_res;
            //      //write_if_quad_to_file("IF_NOTEQ", tmp_quad->arg1, tmp_quad->arg2, tmp_quad->result);
            // }
            break;   
        case 13:
            /*if_less_equal*/
            ...
            //if(arg1 != true_expression && arg2 != true_expression){
            //     if(is_const_num(tmp_quad->arg1) != 1 || is_const_num(tmp_quad->arg2) != 1){
            //         printf(RED"Operants are not type of number, if_greq\n"RESET);
            //         runtime_error = 1;
            //     }
            //     bool_res = get_expr_value(arg1) <=  get_expr_value(arg2);
            //     tmp_quad->result->type = constbool_e;
            //     tmp_quad->result->boolConst = bool_res;
            //     //write_quad_to_file(">", tmp_quad->result->strConst, tmp_quad->result, tmp_quad->arg1, tmp_quad->arg2);
            //  write_quad = 0;

              //}else{
            //     bool_res = is_expression_true(arg1);
            //     tmp_quad->result->boolConst = bool_res;
                //write_if_quad_to_file("IF_LEEQ", tmp_quad->arg1, tmp_quad->arg2, tmp_quad->result);
            // }
            break;
        case 14:
            /*if_greater_equal*/
            ...
            //     bool_res = is_expression_true(arg1);
            //     tmp_quad->result->boolConst = bool_res;
            //     write_if_quad_to_file("IF_GREQ", tmp_quad->arg1, tmp_quad->arg2, tmp_quad->result);
            //write_if_quad_to_file("IF_GREQ", tmp_quad->arg1, tmp_quad->arg2, tmp_quad->result);
        ...
        case 15:
            ...
            // //         runtime_error = 1;
            // //     }
            // //     printf("Result :%d\n", (int)get_expr_value(arg1) >  (int)get_expr_value(arg2));
            // //     bool_res = get_expr_value(arg1) <  get_expr_value(arg2);
            // //     tmp_quad->result->type =constbool_e;
            // //     tmp_quad->result->boolConst = bool_res;
            // //     //write_quad_to_file(">", tmp_quad->result->strConst, tmp_quad->result, tmp_quad->arg1, tmp_quad->arg2);
            ...
            //  }else{
            //         //write_if_quad_to_file("IF_LE", tmp_quad->arg1, tmp_quad->arg2, tmp_quad->result);
        ...
        case 16:
            /*if_greater*/
            // /*edw kanei tin praksi numberA > numberB                 */
            // /* ta true expression einai sinthikes gia na apotimithei */
            // /* to if_greater  
            // tmp_quad->result->type = constbool_e;
            // if(arg1 != true_expression && arg2 != true_expression){
            // //     if(is_const_num(tmp_quad->arg1) != 1 || is_const_num(tmp_quad->arg2) != 1){
            ...
            // //     bool_res = is_expression_true(arg1);
            // //     tmp_quad->result->boolConst = bool_res;
            // //     write_if_quad_to_file("IF_GR", tmp_quad->arg1, tmp_quad->arg2, tmp_quad->result);
            //     //write_if_quad_to_file("IF_GR", tmp_quad->arg1, tmp_quad->arg2, tmp_quad->result);
        ...
        case 17:
            /*call*/
             //write_param_quad_to_file("CALL",tmp_quad->arg1);
            break;
        case 18:
            /*param*/
            //printf("STR  %s\n", tmp_quad->arg1->strConst);
            //write_param_quad_to_file("PARAM",tmp_quad->arg1);
            break;
        case 19:
            /*return*/
            break;
